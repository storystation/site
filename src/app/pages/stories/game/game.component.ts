...
/*  jsonTest = {
    ...
    modules: [
      ...
      },
      {
        ...
        win_condition: ['cyan'],
        response: {
          success: '%character_name% sent l\'ascenseur se déplacer vers le haut. Entre l\'odeur résiduelle des déchets et ses vêtements ' +
            'trempés de sueur, même la mort ne viendrait pas le faucher. Une voix suave lui indique : "Vous êtes bien arrivé au ' +
            '13e étage".',
          fail: 'Suite à son erreur, l\'ascenseur explose et emporte %character_name% dans la tombe.'
        },
        description: 'Rien ne se passe. Est-ce que son téléphone a été traffiqué ? Le logo Samsung apparaît, son téléphone n\'a plus ' +
